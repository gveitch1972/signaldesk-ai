...
DB_RUN_TIMEOUT="${DATABRICKS_RUN_TIMEOUT_SECONDS:-900}"
DB_POLL_INTERVAL="${DATABRICKS_POLL_INTERVAL_SECONDS:-5}"
...
az webapp config appsettings set \
  ...
  --settings \
    ...
    DATABRICKS_RUN_TIMEOUT_SECONDS="$DB_RUN_TIMEOUT" \
    DATABRICKS_POLL_INTERVAL_SECONDS="$DB_POLL_INTERVAL" \
